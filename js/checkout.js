...
// jQuery('.normalSelect2').change(function(){
//     alert("asdas");
// })
// console.log(document.getElementsByClassName('normalSelect2'))
// document.getElementsByClassName('normalSelect2').onchange = function(){
//     alert("asdas")
// };
...
//     alert("asdas");
// })
// var el = document.getElementsByClassName('normalSelect2');
// console.log(el)
...
paypal.Buttons({
    ...
    onApprove: function (data, actions) {
        return actions.order.capture().then(function (details) {
            console.log(details)
            window.location.replace("http://localhost/stripe_payment/success.php")
        })
    },
    onCancel: function (data) {
        window.location.replace("http://localhost/stripe_payment/Oncancel.php")
    }
